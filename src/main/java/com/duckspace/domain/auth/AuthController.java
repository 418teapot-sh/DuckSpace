...
import com.duckspace.domain.auth.dto.TokenExchangeRequest;
...
public class AuthController {
    ...
    public ApiResponse<TokenResponse> exchange(@RequestBody TokenExchangeRequest request) {
        return ApiResponse.success(authService.exchange(request.code()));
    }
